...
const compareSelectedEvents = (clse) => (dispatch) => {
  dispatch({ type: actions.COMPARE_SELECTED_EVENTS })
}
const exitCompareMode = () => (dispatch) => {
  dispatch({ type: actions.EXIT_COMPARE_MODE })
}


export { fetchUserIds, fetchAddresses, fetchEvents, fetchSelectedEventDetails, compareSelectedEvents, exitCompareMode }
